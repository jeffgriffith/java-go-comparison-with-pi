...
public class CalcPi {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		printf("Calculating PI with %d workers and %d elements per worker", numWorkers, elementsPerWorker);

		Latch done = new Latch();
		Timer t = new Timer();
		
		calculatePi(numWorkers, elementsPerWorker).
			thenAccept(pi -> {
    ...
    public static class Timer {
    	...
    	public void stop() {
    		System.out.println(String.format("Elapsed time: %dms", (System.currentTimeMillis() - startTime)));
    	}
    }
